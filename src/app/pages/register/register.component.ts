...
import { EventsService } from 'src/app/services/logs/events.service';
declare var $: any;
...
export class RegisterComponent implements OnInit{
  ...
  constructor(private evntService: EventsService, private router: Router){}
  ...
  onSubmit(form:NgForm){
    ...
    this.evntService.create(formData).subscribe(
      (response: any) => {
